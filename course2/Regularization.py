...
def compute_cost_with_regularization(A3, Y, parameters, lambd):
    ...
    sum_square_W1 = np.sum(np.square(W1))
    sum_square_W2 = np.sum(np.square(W2))
    sum_square_W3 = np.sum(np.square(W3))
    L2_regularization_cost = lambd/(2*m)*(sum_square_W1 + sum_square_W2 + sum_square_W3)
    ### END CODER HERE ###
